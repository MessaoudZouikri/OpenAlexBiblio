...
SUBCATEGORY_KEYWORDS: Dict[str, List[str]] = {
    ...
    "comparative_politics": [
        "comparative", "cross-national", "cross national", "cross-country",
        "institutional", "regime", "party system",
    ],
    "political_theory": [
        "theory", "theoretical", "conceptual", "normative", "definition",
        "philosophical", "genealogy", "intellectual",
    ],
    "electoral_politics": [
        "election", "electoral", "voting", "vote", "ballot", "turnout",
        "volatility", "realignment",
    ],
    "democratic_theory": [
        "democracy", "democratic", "backsliding", "illiberal", "autocratization",
        "liberal", "consolidation", "erosion", "institutional decay",
    ],
    "radical_right": [
        "far-right", "radical right", "extreme right", "right-wing", "extremist",
        "nativist", "authoritarian", "ethnonational",
    ],
    "latin_american_politics": [
        "latin america", "brazil", "venezuela", "argentina", "mexico", "peru",
        "pink tide", "chávismo", "peronism", "andes",
    ],
    "european_politics": [
        "europe", "european union", "france", "germany", "italy", "spain",
        "fidesz", "law and justice", "national rally", "eurosceptic",
    ],

    # Economics subcategories
    "political_economy": [
        "political economy", "macroeconomic", "fiscal policy", "monetary",
        "economic institution", "economic policy",
    ],
    "redistribution": [
        "redistribution", "welfare", "social protection", "inequality",
        "social benefit", "minimum wage",
    ],
    "trade_globalization": [
        "globalization", "globalisation", "trade", "import", "export",
        "protectionism", "offshoring", "automation",
    ],
    "financial_crisis": [
        "crisis", "recession", "austerity", "financial crash", "banking",
        "sovereign debt", "unemployment shock",
    ],

    # Sociology subcategories
    "social_movements": [
        "social movement", "mobilization", "mobilisation", "protest",
        "occupy", "yellow vest", "civil society", "contentious",
    ],
    "identity_politics": [
        "identity", "ethnic", "nationalism", "religion", "nativism",
        "racial", "resentment", "masculinity",
    ],
    "media_communication": [
        "media", "communication", "framing", "social media", "twitter",
        "facebook", "disinformation", "fake news",
    ],
    "culture_values": [
        "culture", "values", "post-material", "cultural backlash", "resentment",
        "status anxiety", "authoritarian personality",
    ],

    # Other subcategories
    "international_relations": [
        "international", "foreign policy", "geopolitics", "diplomacy",
        "multilateral", "nato", "transatlantic",
    ],
    "history": [
        "historical", "history", "19th century", "20th century", "interwar",
        "weimar", "agrarian", "narodniks",
    ],
    "psychology": [
        "psychological", "psychology", "personality", "cognitive", "attitude",
        "authoritarianism", "conspiracy",
    ],
    "geography": [
        "spatial", "geographic", "regional", "urban", "rural", "place-based",
        "electoral geography",
    ],
    "interdisciplinary": [
        "interdisciplinary", "mixed methods", "review",
    ],
}
